...
const bootLines = [
  ...
  { text: '  ║        SHUBHAM KUMAR - SDE 2 @ AWS                       ║', delay: 30, color: '#00d4ff' },
  { text: '  ║  Type "help" to see available commands                     ║', delay: 30, color: '#00d4ff' },
  { text: '  ╚══════════════════════════════════════════════════════════════╝', delay: 30, color: '#00d4ff' },
  { text: '', delay: 200, color: '#00ff41' },
  { text: '  ──────────────────────────────────────────────────────────────', delay: 150, color: '#666' },
  { text: '  Built with Cline (AI pair programmer) + React + Vite | shubham@portfolio', delay: 150, color: '#888' },
  { text: '', delay: 100, color: '#00ff41' },
];
